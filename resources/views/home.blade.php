    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">"The most ambitious Student Team"</h3>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <p class="text-muted">The Project MARCH team consists of full-time and part-time students from Delft University of
                    ...
                    Nuna, Ecorunner and Formula Student from Delft University of Technology.
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="{{asset('img/portfolio/the_pilot.jpg')}}" class="img-responsive" alt="">
                </a>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="portfolio-caption">
                    ...
                    <p class="text-muted">Follow the progress of Project MARCH in a chronoligical timeline.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="portfolio-caption">
                    ...
                    <p class="text-muted">Videos and images on the development and use of the MARCH.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="col-lg-12">
                <form name="sentMessage" id="contactForm" novalidate>
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-center">
                            <div id="success"></div>
                            <button type="submit" class="btn btn-xl sendMessage">Send Message</button>
                            <button type="submit" class="btn btn-xl sendingMessage hidden">Sending...</button>
                        </div>
                    </div>
                </form>
            </div>
