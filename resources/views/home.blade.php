...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">SYMBITRON</a>
        </div>
...
<header>
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading">Building an Exo-Skeleton</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">"The most ambitious Dream Team"</h3>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading">Another Chance</h4>

                <p class="text-muted">The Symbitron Team is one of the prestigious Dreams Teams of the TU Delft and
                    we are laying the foundation for the future.
                    We want to give the paraplegic a second chance by giving them the ability to walk again. Using
                    cutting edge technology
                    and our out-of-the-box thinking, we are confident that we can deliver a remarkable product.
                </p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                ...
                <h4 class="service-heading">Geek is in our blood</h4>

                <p class="text-muted">The core team exists out of men and women with a passion for technology.
                    Bla bla lorem ipsum
                </p>
            </div>
            <div class="col-md-4">
                ...
                <h4 class="service-heading">We want to win!</h4>

                <p class="text-muted">
                    As with every Dream Team, we are not building this Exo-Skeleton just for fun. We are competing at
                    the 2016 Cybathlon in Zurich where we are confident we will grab the first prize and bring it back
                    to our little country. For a first time team we have great ambitions, and it's those ambitions that
