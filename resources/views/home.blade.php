            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <span class="fa-stack fa-4x">
                        ...
                        <h4 class="service-heading">Student Research Team</h4>

                        <p class="text-muted">The Symbitron Team is one of the prestigious Dreams Teams of the TU Delft
                                              and
                                              we are laying the foundation for the future.
                                              We want to give the paraplegic a second chance by giving them the ability
                                              to walk again. Using
                                              cutting edge technology
                                              and our out-of-the-box thinking, we are confident that we can deliver a
                                              remarkable product.
                        </p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <span class="fa-stack fa-4x">
                        ...
                        <p class="text-muted">
                            As with every Dream Team, we are not building this Exo-Skeleton just for fun. We are
                            competing at
                            the 2016 Cybathlon in Zurich where we are confident we will grab the first prize and bring
                            it back
                            to our little country. For a first time team we have great ambitions, and it's those
                            ambitions that
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <p class="text-muted">Lorem ipsum [kort]</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <p class="text-muted">Korte lorem ipsum</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 portfolio-item">
